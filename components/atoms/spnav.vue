...
<div class="nav lg:hidden flex justify-between items-center p-4">
  ...
  <NuxtLink to="/" class="title-link">
    <h1><img src="https://res.cloudinary.com/reshelf/image/upload/v1619871156/Logo_pfuaao.svg" alt="Reshelf Logo" width="120" height="40" class="responsive"></h1>
  </NuxtLink>
  ...
  <nav class="nav__menu pb-32">
    <div class="w-full flex flex-col mx-auto">
      ...
      <ul class="flex flex-col justify-center lg:items-center p-8">
        <li class="link"><a href="#mission" v-scroll-to="{el:'#mission'}">サービスの仕組み</a></li>
        <li class="link"><a href="#qa" v-scroll-to="{el:'#qa'}">Q＆A</a></li>
        <li class="link"><a href="#message" v-scroll-to="{el:'#message'}">創業者のメッセージ</a></li>
        <li class="register"><a href="https://forms.gle/vG8GgqDSUxjm5Pfy7" target="_blank" rel="noreferrer noopener">事前登録</a></li>
      </ul>
    </div>
  </nav>
